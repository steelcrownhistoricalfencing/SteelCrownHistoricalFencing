...
**In wide play, you win through geometry, footwork, and the blade.**

---

## **What Defines the Wide Game**

Three things identify largo:
...
If any of these conditions change, the game changes with them.

---

## **The Two Remedy Masters of Wide Play**
...
In wide play, you typically approach with the left foot forward.
...
## **What Is Available in Wide Play**
...
The most important skill in wide play is not execution.

It is recognition.

Before any largo technique can be applied, you must identify: which crossing are you in, which game does it permit, and which technique is appropriate for this moment.
...
**Exchange of Thrusts** — *Scambiar di Punta* — The primary counter to a thrust at long measure. A single-tempo action that removes your target while creating your own.

**Breaking the Thrust** — *Rompere di Punta* — A sequential counter that beats the blade, presses it to the ground, and closes with a rising cut.

**Peasant's Blow** — *Colpo di Villano* — The counter to an overcommitted strike. Geometry over force.

**Entering at the Crossing** — *Incrosar* — Not a technique but a framework: how to read the crossing and decide which play applies.

---

## **Key Idea**

Wide play is the game of distance.

You win it not by meeting force with force, but by controlling space, reading the crossing, and acting before the opponent has recovered.

**At largo, the fencer who acts first from the crossing wins. The fencer who waits, loses.**
